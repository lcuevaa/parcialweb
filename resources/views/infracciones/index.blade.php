            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h5 class="m-0">Infracciones <button class="btn btn-primary" onclick="nuevo()"><i
                                    class="fas fa-file"></i> Nuevo</button>
                            ...
                            <table class="table table-striped table-bordered table-hover table-sm">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width: 20%">Infraccion</th>
